...
function WorkWithMe() {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-[#7C3AED40] bg-[#0D0F14]"
    >
      ...
      <div className="relative p-5 border-b border-[#7C3AED33]">
        ...
        <p className="text-sm text-foreground/70">
          Share your goals and I’ll propose a pragmatic approach, timeline, and
          fixed‑fee options.
        </p>
      </div>
      ...
      <div className="relative grid gap-6 p-5">
        ...
        <div className="flex flex-wrap items-center gap-3 text-xs text-foreground/60">
          <span className="inline-flex items-center gap-2 rounded-full border border-[#7C3AED66] px-2 py-1">
            Response time: <strong className="text-foreground">~24h</strong>
          </span>
          <span className="inline-flex items-center gap-2 rounded-full border border-[#7C3AED66] px-2 py-1">
            Availability:{" "}
